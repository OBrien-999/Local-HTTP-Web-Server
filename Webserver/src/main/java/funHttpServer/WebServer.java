  ...
  public byte[] createResponse(InputStream inStream) {
    ...
    try {
	  ...
	  if(result == (int)result){
          ...
          builder.append("Content-Type: text/html; charset=utf-8\n");
          builder.append("\n");
          builder.append("Incorrect data provided... ");
	  ...
	  String ownerName = jsonObj.getString("login");
	  String ownerID = jsonObj.getString("id");
	  String repoName = jsonObj.getString("name");

	  System.out.println(ownerName + ", " + ownerID + " -> " + repoName);
